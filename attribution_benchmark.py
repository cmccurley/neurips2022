...
# -*- coding: utf-8 -*-
"""
Created on Tue May  3 18:02:32 2022
...
#                    info['saliency'] = saliency
                ...
                results['pointing'][class_id] = self.pointing.evaluate(y[0], class_id, point[0].detach().cpu())
                results['pointing_difficult'][class_id] = self.pointing_difficult.evaluate(y[0], class_id, point[0].detach().cpu())
